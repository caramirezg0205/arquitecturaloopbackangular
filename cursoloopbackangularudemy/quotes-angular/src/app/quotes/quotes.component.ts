...
export class QuotesComponent implements OnInit {
  ...
  ngOnInit() {
    this.dataService.getData(`${environment.api_url}/api/Quotes/?filter[include]=author&filter[limit]=
  ...
  pageEvent(ev){
    ...
    this.dataService.getData(`${environment.api_url}/api/Quotes/?filter[include]=author&filter[limit]=${pageSize}
      &filter[skip]=${skip}`).subscribe(data => {
      console.log(data);
      this.quotes = data;
    });
  }
